...
wave1endings <- c("ON" = 77 , "AB" = 38, "QC" = 29, "BC" = 9, "SK" = 135, "MB" = 16, "NL" = 7, "NB" = 19, "NS" = 34, "PEI" = 12, "YT" = 7, "NT" = 22, "NU" = NA)
wave2beginings <- c("ON" = 188, "AB" = 133, "QC" = 165, "BC" = 151, "SK" = 194, "MB" = 195, "NL" = 222, "NB" = 185, "NS" = 220, "PEI" = 163, "YT" = 201, "NT" = 200, "NU" = NA)
##Pass "end" to the pipeline to specify that we should end the second wave at the last possible observation date.
wave2endings <- c("ON" = "end", "AB" = 173, "QC" = "214", "BC" = "end" , "SK" = "end", "MB" = "end", "NL" = "end", "NB" = 210, "NS" = "end", "PEI" = 174, "YT" = 216 , "NT" = 214, "NU" = NA)
...
egfs <- sapply(names(splitintervalCases)[names(splitintervalCases) != "NU"], function(provinceName){
  ...
  if (provinceName %in% c("QC", "BC", "NL")){
    if (provinceName =="NL"){
      theFirst <- egf_init(cases = provincetimeseries, date = dates, last = endingwave2)
    }
    else{
