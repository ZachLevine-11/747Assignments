...
wave1beginings <- c("ON" = 11, "AB" = 2, "QC" = 5, "BC" = 1, "SK" = 113, "MB" = 1, "NL" = 1, "NB" = 1, "NS" = 1, "PEI" = 1, "YT" = 1, "NT" = 1, "NU" = NA)
wave1endings <- c("ON" = 77 , "AB" = 38, "QC" = 31, "BC" = 9, "SK" = 135, "MB" = 16, "NL" = 7, "NB" = 19, "NS" = 34, "PEI" = 12, "YT" = 7, "NT" = 22, "NU" = NA)
wave2beginings <- c("ON" = 188, "AB" = 133, "QC" = 164, "BC" = 151, "SK" = 194, "MB" = 195, "NL" = 222, "NB" = 185, "NS" = 220, "PEI" = 163, "YT" = 201, "NT" = 200, "NU" = NA)
##Pass "end" to the pipeline to specify that we should end the second wave at the last possible observation date.
wave2endings <- c("ON" = "end", "AB" = 173, "QC" = 213, "BC" = "end" , "SK" = "end", "MB" = "end", "NL" = "end", "NB" = 210, "NS" = "end", "PEI" = 174, "YT" = 216 , "NT" = 214, "NU" = NA)
...
egfs <- sapply(names(splitintervalCases)[names(splitintervalCases) != "NU"], function(provinceName){
  ...
  return(list("first" = egf_init(date = dates, cases = provincetimeseries, first = beginingwave1, last = endingwave1),
              "second" = egf_init(date = dates, cases = provincetimeseries, first = beginingwave2, last = endingwave2)
)
         )
  })
