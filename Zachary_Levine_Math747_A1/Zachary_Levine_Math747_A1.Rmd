...
wave1beginings <- c("ON" = 10, "AB" = 25, "QC" = 8, "BC" = 2, "SK" = 75, "MB" = 100, "NL" = 1, "NB" = 1, "NS" = 1, "PEI" = 1, "YT" = 1, "NT" = 10, "NU" = NA)
wave2beginings <- c("ON" = 150, "AB" = 150, "QC" = 125, "BC" = 115, "SK" = 140, "MB" = 132, "NL" = 140, "NB" = 140, "NS" = 160, "PEI" = 75, "YT" = 85, "NT" = 140, "NU" = NA)
