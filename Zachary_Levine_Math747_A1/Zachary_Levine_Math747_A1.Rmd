...
##Can explain that there was one case in NU so there's nothing to discuss there.
...
Parameter estimates for epidemic wave one.
```{r, echo = FALSE, results = "asis"}
##Maybe don't do the territories.
##Make the table.
make_table <- function(egf_df, wave = "first"){
  ...
  return(data.frame("Province" = unique(allcases$Province)[(unique(allcases$Province)) != "NU"],
...
Parameter estimates for epidemic wave two.
```{r, echo = FALSE, results = "asis"}
