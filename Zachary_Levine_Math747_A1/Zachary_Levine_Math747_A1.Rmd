...
#Only one wave in NL
wave1beginings <- c("ON" = 11, "AB" = 2, "QC" = 5, "BC" = 1, "SK" = 5, "MB" = 1, "NL" = 1, "NB" = 3, "NS" = 1, "PEI" = 1, "YT" = 1, "NT" = 1, "NU" = NA)
wave1endings <- c("ON" = 77 , "AB" = 38, "QC" = 29, "BC" = 9, "SK" = 16, "MB" = 16, "NL" = 7, "NB" = 23, "NS" = 34, "PEI" = 12, "YT" = 7, "NT" = 22, "NU" = NA)
...
egfs <- sapply(names(splitintervalCases)[names(splitintervalCases) != "NU"], function(provinceName){
  ...
  theFirst <- egf_init(cases = provincetimeseries, date = dates, first = beginingwave1, distr = "pois")
  theSecond <- egf_init(date = anydate(splitintervalCases$NL$Date), cases = splitintervalCases$NL$intervalCases, first = beginingwave2, peak = 205, distr = "pois")
  }
  else{
  theFirst <- egf_init(date = dates, cases = provincetimeseries, first = beginingwave1, last = endingwave1)
